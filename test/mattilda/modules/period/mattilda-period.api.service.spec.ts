...
import {
  PeriodRS,
  PeriodSearch,
} from '../../../../src/mattilda/modules/period/common/mattilda-api-period.types';
import { MattildaPeriodApiService } from '../../../../src/mattilda/modules/period/mattilda-period.api.service';

describe('MattildaPeriodApiService', () => {
  let service: MattildaPeriodApiService;
  ...
  beforeEach(async () => {
    ...
    service = module.get(MattildaPeriodApiService);
